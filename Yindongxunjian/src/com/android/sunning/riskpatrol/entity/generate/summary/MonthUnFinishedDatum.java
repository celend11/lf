...
public class MonthUnFinishedDatum implements SummaryItemDatum{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MonthUnFinishedDatum) == false) {
            return false;
        }
        MonthUnFinishedDatum rhs = ((MonthUnFinishedDatum) other);
