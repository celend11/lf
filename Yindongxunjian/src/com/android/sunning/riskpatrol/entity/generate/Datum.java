...
public class Datum extends BaseEntity{
     ...
     *     The JianChaFuZeRenC
     */
    public void setJianChaFuZeRenC(com.android.sunning.riskpatrol.entity.generate.JianChaFuZeRenC JianChaFuZeRenC) {
     ...
     *     The Company
     */
    public void setCompany(com.android.sunning.riskpatrol.entity.generate.Company Company) {
     ...
     *     The ShouJianFuZeRen
     */
    public void setShouJianFuZeRen(com.android.sunning.riskpatrol.entity.generate.ShouJianFuZeRen ShouJianFuZeRen) {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(NormalID).append(JianChaFuZeRenC).append(InspectType).append(InspectWay).append(InspectTimeArranged).append(InspectWayTxt).append(Site).append(JianChaXiangMu).append(InspectNum).append(InspectNumFormat).append(Company).append(InspectTime).append(JianChaFuZeRen).append(ShouJianFuZeRen).append(CanJianRenYuan).append(CanJiaRenYuanInput).append(BeiZhu).append(LastReViewStatus).append(AttachmentCount).append(CreateTime).append(CreatorID).append(CreatorName).append(Status).append(CheckListStatus).append(SubCount).append(ReformStatusTxt).append(CheckListStatusTxt).append(InspectDiscription).append(CheckResultRemark).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(NormalID, rhs.NormalID).append(JianChaFuZeRenC, rhs.JianChaFuZeRenC).append(InspectType, rhs.InspectType).append(InspectWay, rhs.InspectWay).append(InspectTimeArranged, rhs.InspectTimeArranged).append(InspectWayTxt, rhs.InspectWayTxt).append(Site, rhs.Site).append(JianChaXiangMu, rhs.JianChaXiangMu).append(InspectNum, rhs.InspectNum).append(InspectNumFormat, rhs.InspectNumFormat).append(Company, rhs.Company).append(InspectTime, rhs.InspectTime).append(JianChaFuZeRen, rhs.JianChaFuZeRen).append(ShouJianFuZeRen, rhs.ShouJianFuZeRen).append(CanJianRenYuan, rhs.CanJianRenYuan).append(CanJiaRenYuanInput, rhs.CanJiaRenYuanInput).append(BeiZhu, rhs.BeiZhu).append(LastReViewStatus, rhs.LastReViewStatus).append(AttachmentCount, rhs.AttachmentCount).append(CreateTime, rhs.CreateTime).append(CreatorID, rhs.CreatorID).append(CreatorName, rhs.CreatorName).append(Status, rhs.Status).append(CheckListStatus, rhs.CheckListStatus).append(SubCount, rhs.SubCount).append(ReformStatusTxt, rhs.ReformStatusTxt).append(CheckListStatusTxt, rhs.CheckListStatusTxt).append(InspectDiscription, rhs.InspectDiscription).append(CheckResultRemark, rhs.CheckResultRemark).isEquals();
    }
