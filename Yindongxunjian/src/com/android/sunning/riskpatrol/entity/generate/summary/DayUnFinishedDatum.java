...
public class DayUnFinishedDatum implements SummaryItemDatum{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DayUnFinishedDatum) == false) {
            return false;
        }
        DayUnFinishedDatum rhs = ((DayUnFinishedDatum) other);
