...
public class WeekUnFinishedDatum implements SummaryItemDatum{
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WeekUnFinishedDatum) == false) {
            return false;
        }
        WeekUnFinishedDatum rhs = ((WeekUnFinishedDatum) other);
